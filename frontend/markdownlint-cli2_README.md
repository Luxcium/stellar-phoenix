...
This section provides information about markdownlint-cli2.
...
This section contains information about markdownlint-cli2.
...
This section provides information about command line.
...
This section contains information about command line.
...
This section provides information about container image.
...
This section contains information about container image.
...
This section provides information about exit codes.
...
This section contains information about exit codes.
...
This section provides information about rule list.
...
This section contains information about rule list.
...
This section provides information about glob expressions.
...
This section contains information about glob expressions.
...
This section provides information about configuration.
...
This section contains information about configuration.
...
This section provides information about `.markdownlint-cli2.jsonc`.
...
This section contains information about `.markdownlint-cli2.jsonc`.
...
This section provides information about `.markdownlint-cli2.yaml`.
...
This section contains information about `.markdownlint-cli2.yaml`.
...
This section provides information about `.markdownlint-cli2.cjs` or `.markdownlint-cli2.mjs`.
...
This section contains information about `.markdownlint-cli2.cjs` or `.markdownlint-cli2.mjs`.
...
This section provides information about `package.json`.
...
This section contains information about `package.json`.
...
This section provides information about `.markdownlint.jsonc` or `.markdownlint.json`.
...
This section contains information about `.markdownlint.jsonc` or `.markdownlint.json`.
...
This section provides information about `.markdownlint.yaml` or `.markdownlint.yml`.
...
This section contains information about `.markdownlint.yaml` or `.markdownlint.yml`.
...
This section provides information about `.markdownlint.cjs` or `.markdownlint.mjs`.
...
This section contains information about `.markdownlint.cjs` or `.markdownlint.mjs`.
...
This section contains information about compatibility.

### `markdownlint-cli`

This section provides information about `markdownlint-cli`.
...
This section contains information about `markdownlint-cli`.
...
This section provides information about `vscode-markdownlint`.
...
This section contains information about `vscode-markdownlint`.

- `.markdownlintignore` is not supported.

## pre-commit

This section provides information about pre-commit.
...
This section contains information about pre-commit.
